...
export const metadata: Metadata = {
  title: 'Hong Kong Mahjong â Rules, Strategy, and Scoring',
  description:
...
const faqs = [
  {
    ...
    answer:
      'Yes. It is one of the most approachable mahjong styles because the core rules are straightforward â build four sets and one pair â and there is no annual card to memorize. New players can start with basic hands and gradually learn the scoring system as they gain experience.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Faan is the scoring unit used to measure how valuable a hand is. Different hand features and patterns add faan â for example, self-draw, a pure suit hand, or a set of dragons. Many groups require a minimum number of faan to win, and the payout structure often scales with the total faan achieved.',
  },
  {
...
const articleData = {
  headline: 'Hong Kong Mahjong â Rules, Strategy, and Scoring',
  description:
      ...
      >
        <div className="mx-auto max-w-3xl">
          <div className="content-article" style={{ color: 'var(--espresso)' }}>
            ...
            <ul>
              <li>
                <strong>Pong</strong> â Three identical tiles
              </li>
              <li>
                <strong>Chow</strong> â Three consecutive tiles in the same suit (Example: 4-5-6
                bamboo)
              </li>
              <li>
                <strong>Kong</strong> â Four identical tiles
              </li>
              <li>
                <strong>Pair</strong> â Two identical tiles
              </li>
            </ul>
            ...
            <ul>
              <li>
                <strong>Chow</strong> â can usually only be claimed from the player immediately
                before you.
              </li>
              <li>
                <strong>Pong</strong> â can be claimed from any player if you have the other two
                matching tiles.
              </li>
              <li>
                <strong>Kong</strong> â can be declared if you complete a four-of-a-kind.
              </li>
            </ul>
            ...
            <p>
              ...
              each additional faan doubles the base payment â this creates a strong incentive to push
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>Low value â efficient but not high scoring</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>7 faan â a high-value target</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>No called tiles â entire hand drawn from the wall</td>
            ...
            <ol>
              <li>
                <strong>Build efficiently â focus on shape.</strong> In early rounds, prioritize
              ...
              <li>
                ...
                slow down. Avoid discarding dangerous tiles â especially honor tiles and terminal
            ...
            <ul>
              ...
              <li>
                ...
                off in a big way â and a risky discard can cost you.
              </li>
              <li>
            ...
            <ul>
              <li>
                <Link href="/compare/mahjong-styles">Compare Mahjong Styles</Link> â see how Hong
                Kong Mahjong stacks up against Taiwanese and American Mahjong side by side.
              </li>
              <li>
                <Link href="/learn/how-to-play-mahjong">How to Play Mahjong</Link> â a
                beginner-friendly overview of the shared rules and concepts across all styles.
              </li>
              <li>
                <Link href="/events">Browse Events</Link> â find mahjong events and game nights in
